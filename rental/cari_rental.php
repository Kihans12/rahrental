...
tbl_rental_rizki_akhiramdhani_harahap.no_plat_rizki_akhiramdhani_harahap=tbl_mobil_rizki_akhiramdhani_harahap.no_plat_rizki_akhiramdhani_harahap WHERE nama_rizki_akhiramdhani_harahap like '%$keyword%'");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $data['lama_rizki_akhiramdhani_harahap']  ?>
                                    </td>
                                    <td>
